								...
								{attendances.map((att, i) => {
									...
									return (
										...
										>
											...
											<td className='py-3 px-3 text-white/80 font-medium text-sm'>
												{fullName}
											</td>
											<td className='py-3 px-3 min-w-[140px]'>
												<div className='flex items-center gap-2'>													<span className='text-white/60 text-sm truncate max-w-[160px]'>
														{event?.title ?? 'N/A'}
													</span>
													{event && (
														<button
